...
//MCP3008
#define MCP3008_CS0 D10//D10
#define MCP3008_CS1 D9 //D9
...
//????
#define A_SENS_DIS_EA0_PIN A0 //A0 46
#define A_SEND_AF_EA1_PIN A1 //A1
...
#define A_SENS_LP_4_PIN  (adc_channel_t){ADC_1,5}
#define A_SENS_LP_5_PIN  (adc_channel_t){ADC_1,6}
...
#define A_SENS_NOSE_0_PIN  (adc_channel_t){ADC_2, 0}
#define A_SENS_NOSE_1_PIN  (adc_channel_t){ADC_2, 8}
